...
$query_Recordset1 = "SELECT * FROM oil group by date ORDER BY `date` DESC";
$Recordset1 = mysql_query($query_Recordset1, $database) or die(mysql_error());
$row_Recordset1       = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

$query_Recordset3 = "SELECT * FROM oil ORDER BY `date` DESC LIMIT 1;";
...
$query_Recordset7 = "SELECT ADDDATE(date, 1) as date FROM oil ORDER BY `date` DESC LIMIT 1;";
...
$query_Recordset5 = "SELECT monthname(date) AS month,year(date) AS year,sum(amount) AS amount,sum(sales) AS sales,sum(`recipt no`) AS recpitno FROM oil GROUP BY month(date),year(date);";
...
<ul>
<li><a href="#tabs-1" role="tab" data-toggle="tab">Oil</a></li>
<li><a href="#tabs-3" role="tab" data-toggle="tab">Oil month</a></li>
</ul>
...
?>" method="post" name="form1" id="form1">
 ...
 <a href="word/oiltotal.php">genarate word</a>
...
?></td>
    ...
    echo $row_Recordset1['date'];
?>&amp;type=oil" class="btn btn-primary">update</a></td>
        <td><a href="delete.php?date=<?php
    echo $row_Recordset1['date'];
?>&amp;type=oil" class="btn btn-primary">delete</a></td>
      </tr>
      <?php
...
<div  id="tabs-3" class="tab-pane" style="overflow: scroll;">
 <a href="word/oilmonth.php">genarate report</a>
