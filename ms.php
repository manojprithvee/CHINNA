...
$query_Recordset1 = "SELECT * FROM ms group by `date` ORDER BY `date` DESC";
...
$query_Recordset7 = "SELECT ADDDATE(date, 1) as date FROM ms ORDER BY `date` DESC LIMIT 1;";
...
$query_Recordset5 = "SELECT monthname(date) AS month,year(date) AS year,sum(amount) AS amount,sum(sales) AS sales,sum(`recipt no`) AS recpitno FROM ms GROUP BY month(date),year(date) ORDER BY year DESC ,month(date);";
...
<ul>
<li><a href="#tabs-1" role="tab" data-toggle="tab">Ms</a></li>
<li><a href="#tabs-3" role="tab" data-toggle="tab">Ms month</a></li>
</ul>
...
?>" method="post" name="form1" id="form1">
        ...
        <tr valign="baseline">
          ...
          <td><input type="submit"class="btn btn-success" value="Insert record" /></td>
        </tr>
      </table>
 ...
 <a href="word/mstotal.php">genarate word</a>
...
?></td>
    ...
    echo $row_Recordset1['date'];
?>&amp;type=ms" class="btn btn-primary">update</a></td>
        <td ><a href="delete.php?date=<?php
    echo $row_Recordset1['date'];
?>&amp;type=ms" class="btn btn-primary">delete</a></td>
      </tr>
      <?php
...
<div  id="tabs-3" class="tab-pane" style="overflow: scroll;">
 <a href="word/msmonth.php">genarate report</a>
